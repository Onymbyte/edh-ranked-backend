...
class Listing(db.Model):
    ...
    color_identity = db.Column(db.String(5), index=True, unique=False)
    mana_cost = db.Column(db.String(36), index=True, unique=True)
    cmc = db.Column(db.Integer, index=True, unique=False)
...
class CardRating(db.Model):
    ...
    listing = db.relationship("Listing", backref="cardRating")
